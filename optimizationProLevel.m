            ...
            if length(sy_sow)>=2
                ...
                [x,~,exitflag,~]=intlinprog(f,intcon,A,b,Aeq,Beq,lb,ub,x0); %
                 if exitflag==1
                    ...
                    total_varibalesum=sum(syzsum_varibalesum); % 总共的转移方式
                   ...
                   area_total_max(area_total_max>sum(sow_area))=sum(sow_area);
                      ...
                      if ~isempty(sy_decrease)
                            ...
                            area_xs_sum_total=[area_xs_sum_total_1;area_xs_sum_total_2]; % 优化后的系数
                            ...
                            area_total_max_3=[area_total_max_1;area_total_max_2]; % 优化后的总面积最大值
